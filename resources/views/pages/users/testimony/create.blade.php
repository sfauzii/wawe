...
@section('content')
    ...
    <div class="content">
        <div class="profile-container">
            <form class="edit-profile-form" action="{{ route('testimony.store') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <div class="form-group">
                    <label for="full-name">Full Name</label>
                    <input type="text" id="name" name="name" value="{{ $user->name }}" name="full-name" required>
                </div>
                <div class="form-group">
                ...
                <div class="photo-upload">
                    ...
                    <input type="file" id="photos" name="photos[]" multiple accept="image/*" onchange="loadFile(event)" />
