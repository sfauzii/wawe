...
<body style="word-spacing:normal;background-color:#E4E5EB; padding-top: 20px; padding-bottom: 20px;">
    <div style="background-color:#E4E5EB;" lang="und" dir="auto">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    style="font-family:Playfair Display, Times New Roman, serif;font-size:30px;font-weight:bold;line-height:18px;text-align:center;color:#071C4D;">
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    border="0"
                                                                    style="color:#071C4D;font-family:Poppins sans-serif;font-size:18px;line-height:22px;table-layout:auto;width:100%;border:none;">
                                                                    <tr>
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="3"><strong>Total Price</strong>
                                                                        </td>
                                                                        <td style="text-align: right;">
                                                                        ...
                                                                        <tr>
                                                                            {{-- <td align="center" bgcolor="#FF9e53"
                                                                                ...
                                                                                <button onclick="printPage()"
                                                                                    style="background:#FF9e53;color:#FFFFFF;font-family:Poppins sans-serif;font-size:18px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;border-radius:10px;cursor:pointer;">Print</button>
                                                                            </td> --}}
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            {{-- <td align="center" bgcolor="transparent"
                                                                                role="presentation"
                                                                                style="border:2px solid #FF9e53;border-radius:10px;cursor:auto;mso-padding-alt:10px 25px;background:transparent;"
                                                                                valign="middle">
                                                                                <a href="{{ route('testimoni.create', $item->id) }}"
                                                                                    style="display:inline-block;background:transparent;color:#FF9e53;font-family:Poppins sans-serif;font-size:18px;font-weight:bold;line-height:120%;  margin:0;text-decoration:none;text-transform:none;padding:8px 25px;mso-padding-alt:0px;border-radius:10px;border:2px solid #FF9e53;">
                                                                                    Beri Testimoni </a>
                                                                            </td> --}}
                                                                        </tr>
                                                                    </tbody>
                                            ...
                                            <td align="left"
                                                ...
                                                {{-- <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td
                                                            style="font-size: 18px; padding-left: 15px; color: #071C4D; font-family: Assistant, Helvetica, Arial, sans-serif">
                                                            support@poling.id <br> 0239-2300-29032 </td>
                                                    </tr>
                                                </table> --}}
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    ...
                                                    2024 WaWe Copyright All Rights Reserved</div>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>Travel Package: {{ $transaction->travel_package->title }}</p>
                        <p>Price: {{ $transaction->travel_package->price }}</p>
