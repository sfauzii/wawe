                        ...
                        <form action="{{ route('travel-package.store') }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <small class="form-text text-muted">Keterangan package. Contoh: Deskripsi dari tempat
                                        package</small>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <small class="form-text text-muted">Fasilitas package. Contoh: Fasilitas 1, Fasilitas 2,
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <small class="form-text text-muted">Tanggal keberangkatan package. Contoh: 15 Juni 2017.
                                        Wajib diisi</small>
                                </div>
                            </div>
