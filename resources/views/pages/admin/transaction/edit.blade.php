                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('transaction.update', $item->id) }}" method="POST">
                            ...
                            <div class="row mb-3">
                                <label for="transaction_status" class="col-sm-2 col-form-label" style="font-weight: bold; color: #012970;">Status</label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-5">
                                <div class="col-sm-10">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span style="font-weight: bold;"><i class="ri-calendar-schedule-line"></i> Created At: <span style="color: #000000; font-weight: 400   ">{{ $item->created_at->setTimezone('Asia/Jakarta')->format('j F Y, H:i T')  }}</span></span>
                            ...
                            <div class="row mb-5">
                                <div class="col-sm-10">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span style="font-weight: bold;"><i class="ri-calendar-schedule-line"></i> Updated At: <span style="color: #000000; font-weight: 400   ">{{ $item->updated_at->setTimezone('Asia/Jakarta')->format('j F Y, H:i T')  }}</span></span>
                                        <!-- Tanggal yang sesuai akan ditampilkan di sini -->
                                    </div>
                                </div>
                            </div>
