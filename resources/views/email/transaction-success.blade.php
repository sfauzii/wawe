                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="width:200px;">
                                                                    <img alt=""
                                                                        src="{{ url('frontend/svg/images/logo.svg') }}"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        style="font-family:Assistant, Helvetica, Arial sans-serif;font-size:18px;line-height:18px;text-align:left;color:#071C4D;">
                                                                        Hi, {{ $data->user->name }} <br><br> Tiket
                                                                        digital kamu sudah berhasil dicetak. <br>
                                                                        Booking ID
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td align="center" bgcolor="#FF9e53"
                                                                                    ...
                                                                                    valign="middle">
                                                                                    <a href="{{ url('/my-ticket/ticket-detail/' . $data->id) }}"
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td
                                                                ...
                                                                WaWe Tour and Travel <br> 0857 8619 2909 </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="center"
                                                    ...
                                                    <div
                                                        ...
                                                        2024 WaWe Tour and Travel Copyright All Rights Reserved</div>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
