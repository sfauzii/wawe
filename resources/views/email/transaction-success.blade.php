...
<body style="word-spacing:normal;background-color:#E4E5EB;">
                          ...
                          <tbody>
                            <tr>
                              <td style="width:200px;">
                                <img alt="" src="{{ url('frontend/images/logo.png') }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="200" height="auto" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:30px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Playfair Display, Times New Roman, serif;font-size:30px;font-weight:bold;line-height:18px;text-align:center;color:#071C4D;">Don't Forget Your E-Ticket</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
                      ...
                      <td style="border-bottom:1px dashed #eee;vertical-align:middle;padding-bottom:30px;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                          <tbody>
                            ...
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#071C4D;font-family:Assistant, Helvetica, Arial sans-serif;font-size:18px;line-height:22px;table-layout:auto;width:100%;border:none;">
                                  <tr>
                                    <td colspan="3"> Members </td>
                                  </tr>
                                  @foreach ($data->details as $item)
                                  <tr>
                                    <td colspan="3"><strong>{{ $item->username }}</strong></td>
                            ...
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#071C4D;font-family:Assistant, Helvetica, Arial sans-serif;font-size:18px;line-height:22px;table-layout:auto;width:100%;border:none;">
                                  ...
                                  <tr>
                                    <td colspan="3"><strong>Departure</strong></td>
                                    <td style="text-align: right;"> {{ $data->travel_package->title }} </td>
                                  </tr>
                                  <tr>
                                    <td colspan="3"><strong>Date and Time</strong></td>
              ...
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:middle;" width="100%">
                  <tbody>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Assistant, Helvetica, Arial sans-serif;font-size:18px;line-height:18px;text-align:left;color:#071C4D;">Butuh bantuan?</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
                      ...
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                          <tr>
                            ...
                            <td style="font-size: 18px; padding-left: 15px; color: #071C4D; font-family: Assistant, Helvetica, Arial, sans-serif"> support@poling.id <br> 0239-2300-29032 </td>
                          </tr>
                        </table>
                      </td>
                    </tr>
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:0px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:1;text-align:center;color:#888b93;">2024 Poling Copyright All Rights Reserved</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
