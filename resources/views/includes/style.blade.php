...
<link rel="stylesheet" href="{{ url('frontend/styles/carousel-package.css') }}" />
<link rel="stylesheet" href="{{ url('frontend/styles/modal-login.css') }}" />

{{-- <link rel="stylesheet" href="{{ url('frontend/styles/swiper-bundle.min.css') }}" /> --}}
