<div>
    <ul class="nav nav-tabs d-flex justify-content-center custom-nav-tabs" id="paymentTabs" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link {{ $paymentMethod === 'down_payment' ? 'active' : '' }}"
                wire:click="$set('paymentMethod', 'down_payment')" href="#downpayment" role="tab">Down Payment</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link {{ $paymentMethod === 'full_payment' ? 'active' : '' }}"
                wire:click="$set('paymentMethod', 'full_payment')" href="#fullpayment" role="tab">Full Payment</a>
        </li>
    </ul>
