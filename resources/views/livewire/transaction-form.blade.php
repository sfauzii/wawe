<section class="section">
    <div class="row">
                    ...
                    <form wire:submit.prevent="createTransaction">
                                ...
                                <select wire:model.live="selectedPackageId" id="travel_package" class="form-select"
                                    ...
                                    @foreach ($travelPackages as $package)
                                        <option value="{{ $package->id }}" data-price="{{ $package->price }}">
                                            {{ $package->title }} (Quota: {{ $package->kuota }}) - Rp
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" wire:model="newUsername" id="newUsername" class="form-control"
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Total Transaction <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" value="{{ number_format($totalAmount, 0, ',', '.') }}" style="font-weight: bold;"
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title"><div class="alert alert-success">This is the quota package information that can be used for a number of reasons.</div></h5>
